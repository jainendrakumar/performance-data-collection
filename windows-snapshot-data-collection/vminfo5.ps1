...
$topProcesses = Get-Process | Sort-Object CPU -Descending | Select-Object -First 10 ProcessName, CPU, WS, VM, Id, Threads, Handles
$topServices = Get-WmiObject Win32_Service | Sort-Object ProcessId | Select-Object -First 10 Name, State, StartMode, ProcessId
$topDiskProcesses = Get-WmiObject Win32_PerfFormattedData_PerfProc_Process | Sort-Object IODataOperationsPerSec -Descending | Select-Object -First 10 Name, IODataOperationsPerSec, IOReadOperationsPerSec, IOWriteOperationsPerSec
$topNetworkProcesses = Get-NetAdapterStatistics | Sort-Object BytesSentPerSec -Descending | Select-Object -First 10 Name, BytesSentPerSec, BytesReceivedPerSec
...
"`nTop 10 Disk-Intensive Applications:`n" | Out-File -FilePath $outputFile -Append -Encoding utf8
$topDiskProcesses | Format-Table -AutoSize | Out-File -FilePath $outputFile -Append -Encoding utf8

"`nTop 10 Network-Intensive Applications:`n" | Out-File -FilePath $outputFile -Append -Encoding utf8
$topNetworkProcesses | Format-Table -AutoSize | Out-File -FilePath $outputFile -Append -Encoding utf8
