...
$LogPath = "C:\VM_Information_Status17.txt"
...
INCLUDES: Errors, Critical, Warnings, Crashes, Shutdowns, Cluster Errors
=====================================================
"@
...
# Extracting logs for Crashes and Shutdowns with Reasons
...
# Extract Cluster & Failover Issues
$ClusterFailoverLogs = Get-WinEvent -FilterHashtable @{
...
@"
=====================================================
SYSTEM CRASHES & SHUTDOWNS WITH REASON
=====================================================
"@ | Out-File -FilePath $LogPath -Append
...
=====================================================
"@ | Out-File -FilePath $LogPath -Append
$ClusterFailoverLogs | Out-File -FilePath $LogPath -Append
